class Employee:
    def __init__(self, name, position, salary):  # Corrected the constructor method
        self.name = name
...
class EmployeeManagerAdapter(EmployeeManagerAbstraction):
    def __init__(self, manager):  # Corrected the constructor method
...
class ReportGenerator:
    def __init__(self, manager, report):  # Corrected the constructor method
        self.manager = manager
        self.report = report
